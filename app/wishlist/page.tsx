...
// ── Mock wishlist data using real product IDs ──────────────────────────────────
                  ...
                  {items.map((item, i) => (
                    ...
                    >
                      ...
                      <div className="p-4 flex flex-col flex-1">
                        ...
                        {/* Name - Wrap in Link */}
                        <Link href={`/products/${item.id}`}>
                          <h3 className="font-semibold text-foreground text-sm leading-snug mb-2.5 line-clamp-2 flex-1 hover:text-primary transition-colors">
                            {item.name}
                          </h3>
                        </Link>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex items-center gap-1 text-[11px] text-green-600 font-semibold mt-1">
                            ...
                            <span>{formatPKR(item.installment)}/mo · 12 months</span>
                          </div>
                        </div>
