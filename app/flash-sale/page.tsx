...
const FLASH_PRODUCTS = [
  {
    id: 'f1', name: PRODUCTS_DATA['f1'].name,
    category: 'phones', categoryLabel: 'Smartphones',
    price: PRODUCTS_DATA['f1'].price, original: PRODUCTS_DATA['f1'].originalPrice || 0, discount: PRODUCTS_DATA['f1'].discount || 0,
    installment: PRODUCTS_DATA['f1'].installmentPlans[0]?.monthly || 0, rating: PRODUCTS_DATA['f1'].rating, reviews: PRODUCTS_DATA['f1'].reviewCount,
    stock: 7, totalStock: 30,
    image: PRODUCTS_DATA['f1'].images[0],
    shop: PRODUCTS_DATA['f1'].vendor, shopId: 'vendor-techzone-001', verified: true, hot: true,
  },
  {
    id: 'f2', name: PRODUCTS_DATA['f2'].name,
    category: 'laptops', categoryLabel: 'Laptops',
    price: PRODUCTS_DATA['f2'].price, original: PRODUCTS_DATA['f2'].originalPrice || 0, discount: PRODUCTS_DATA['f2'].discount || 0,
    installment: PRODUCTS_DATA['f2'].installmentPlans[0]?.monthly || 0, rating: PRODUCTS_DATA['f2'].rating, reviews: PRODUCTS_DATA['f2'].reviewCount,
    stock: 5, totalStock: 10,
    image: PRODUCTS_DATA['f2'].images[0],
    shop: PRODUCTS_DATA['f2'].vendor, shopId: 'vendor-digiworld-002', verified: true, hot: true,
  },
  {
    id: 'f3', name: PRODUCTS_DATA['f3'].name,
    category: 'bikes', categoryLabel: 'Bikes',
    price: PRODUCTS_DATA['f3'].price, original: PRODUCTS_DATA['f3'].originalPrice || 0, discount: PRODUCTS_DATA['f3'].discount || 0,
    installment: PRODUCTS_DATA['f3'].installmentPlans[0]?.monthly || 0, rating: PRODUCTS_DATA['f3'].rating, reviews: PRODUCTS_DATA['f3'].reviewCount,
    stock: 12, totalStock: 20,
    image: PRODUCTS_DATA['f3'].images[0],
    shop: PRODUCTS_DATA['f3'].vendor, shopId: 'vendor-speedriders-003', verified: true, hot: false,
  },
]
